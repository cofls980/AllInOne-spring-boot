...
import com.hongik.pcrc.allinone.application.Authentication.JwtFilter;
...
public class Config extends WebSecurityConfigurerAdapter {// implements WebMvcConfigurer {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable().authorizeRequests().antMatchers("/v1/auth/*") //요펑에 대한 권한 지정, 403 error
                .permitAll().anyRequest().authenticated() //접근을 전부 허용, 인증되어야 함.
